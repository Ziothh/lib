...
export class ImageGalleryController {
    ...
    constructor (galleryElement?: HTMLElement ) {
        this.container = galleryElement || DOM.Helpers.getByDataAttribute("role", this.dataRoles.container)!

        // HTML elements with image data
        this.images = Array.from(
            DOM.Helpers.getAllByDataAttribute(
                "role", 
        ...
        // Navigation Buttons
        const previousBtn =  DOM.Helpers.getByDataAttribute(
            "role", this.dataRoles.buttons.previous
        ) as HTMLButtonElement
        const nextBtn =  DOM.Helpers.getByDataAttribute(
        ...
        // Display container
        this.displayedImageContainer = DOM.Helpers.getByDataAttribute(
            "role",
